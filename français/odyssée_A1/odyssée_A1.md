Alliance Française(회현)에서의 프랑스어 수업
...
- roux : a. 다갈색의, une couleur un peu rouge ou orange (f. rousse)
- gris : a. 회색의
...
La taille
- Elle est grande : elle fait / mesure 1,75 mètre.
- Il est de taille moyenne : il mesure 1,75 mètre.
- Il est petit : il fait 1,68 mètre.

- moyen : a. 중간의 (f. moyenne)
- être de taille moyenne : 평균 키이다

La corpulence
- Elle est (un peu) ronde : elle fait / pèse 65 kilos.
- Elle est forte / grosse.
- Il est un peu fort / grosse.
- Il est mince : il pèse / fait 69 kilos.
- Il est très mince, il est maigre : il fait / pèse 55 kilos.

- corpulence : nf. 체격
- peser : vt. (무게를) 달다
- fort : a. 체격이 좋은, 큰, 튼튼한, 살찐, 뚱뚱한
- grand > moyen > petit
- ronde > forte > mince > maigre
...
- vingtaine : nf. 약 20 (dizaine : nf. 약 10)
- âgé : a. 나이가 있는
- d'un certain âge : 어느 정도 나이가 있는

Expressions pour aller plus loin
- Il est maigre comme un clou. (très maigre)
- Elle est jolie comme un coeur. (très jolie)
- Elle est frisée comme un mouton. (très frisée)
- Elle est blond comme les blés. (très blond)
- Il ne fait pas son âge : il paraît plus jeune.

- clou : nm. 못
- cœur : nm. 심장
- mouton : nm. 양
- blés : nm. 밀, 소맥, 곡물
- Il ne fait pas son âge : 당신은 나이와는 달라보여요.
- paraître : ~처럼 보이다 (→ sembler, 영어의 seem, appear)
